...
![](http://img-blog.csdn.net/2018071815044218)
...
参考文章:[Efficient Graph-Based Image Segmentation](http://cs.brown.edu/people/pfelzens/papers/seg-ijcv.pdf)
...
> 
> ![](http://img-blog.csdn.net/20171206104959304)
> 
...
![](http://img-blog.csdn.net/20171206105413116)
...
![](http://img-blog.csdn.net/20171206111022215)
...
> 
> ![](http://img-blog.csdn.net/20171206112900548)
> 
...
> 
> if 不相似度小于二者内部不相似度: 更新阈值以及类标号;
> else: 如果i < n,则按照排好的顺序,选择下一条边转到Step 4,否则结束。
...
![](http://pic3.zhimg.com/v2-59a946e53af73256d539832715cb7270_r.jpg)
...
![](http://pic4.zhimg.com/v2-ae9e64e28edb33d6eb6dee24f2f7a4b1_r.jpg)
...
> 
> ![](http://pic3.zhimg.com/v2-5c90d18eb5e5b2a49770bcbabd88de25_b.jpg)
> 
> 合并区域的颜色直方图计算如下:
> 
> ![](http://picb.zhimg.com/v2-a7ba97c666760e14999559c468493d81_b.jpg)
> 
> ![](http://pic1.zhimg.com/v2-0538757fd74b18fe0b09989be9c08c8c_b.jpg)
> 
> 纹理相似度衡量: 论文采用SIFT-Like特征,具体操作:采用方差为1的高斯分布对每个颜色通道的8个不同方向做梯度统计,然后将统计结果(尺寸与区域大小一致)以bins=10计算直方图。直方图区间数为8*3*10=240。
> 
> ![](http://pic4.zhimg.com/v2-1763310124be08c02d738057700264ba_b.jpg)
> 
> $T_{i}=\left\{t_{i}^{1}....t_{i}^{n} \right\}$表示每一个区域的纹理直方图,有240维。
> 
> 尺度相似度衡量: 为了保证区域合并操作的尺度较为均匀,使用如下公式,使用尺寸相似度,目的是尽量让小的区域先合并。
> 
> ![](http://pic4.zhimg.com/v2-7fff103ae7c911238f53a51a940de191_b.jpg)
> 
> size(im)是指区域中的尺寸(以像素为单位)
> 
> 形状重合度衡量:为了衡量两个区域是否更加重合,合并后区域的Bounding Box越小,其重合度越高,公式如下。
> 
> ![](http://pic1.zhimg.com/v2-fb90449b98b8a35eb36409a46ddd2965_b.jpg)
> 
> 最终的相似度衡量:
> 
> ![](http://pic3.zhimg.com/v2-daf7edc09c59b6cb36d8cbf7e0afed00_b.jpg)

![](http://pic4.zhimg.com/v2-2985adf17a83a2f3f7e77926f2cf7628_r.jpg)
